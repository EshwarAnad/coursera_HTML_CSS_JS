...
$ajaxUtils.sendGetRequest(
  allCategoriesUrl,
  buildAndShowHomeHTML, // ***** <---- TODO: STEP 1: Substitute [...] ******  test with logme --> 
  true); // Explicitly setting the flag to get JSON from server processed into an object literal
});
// *** finish **

//////////////////// testing ///////////////////
function logme (categories){ //used to test data from server
  console.log(categories);   //20 element array, see [0] below
}                            
/************* 
id: 81       category object
name: "Lunch"
short_name: "L"
...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    homeHtmlUrl,
    function (homeHtml) {    //param ???
      let html = homeHtml;
      //returns a rand element from the category array. see example object above. get short_name val for chosen
      ...
      homeHtml = insertProperty(html, "randomCategoryShortName", `'${chosenCategoryShortName}'`);  //string, propName, propValue  replace mid with last
